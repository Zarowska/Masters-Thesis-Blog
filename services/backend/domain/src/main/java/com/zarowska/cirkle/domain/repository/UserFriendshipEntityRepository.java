...
public interface UserFriendshipEntityRepository extends JpaRepository<FriendshipEntity, UUID> {
	...
	Optional<FriendshipEntity> getUserFriendshipWith(@Param("currentUserId") UUID currentUserId,
	...
	Optional<FriendshipEntity> findBySenderAndReceiver(UserEntity sender, UserEntity receiver);
}
