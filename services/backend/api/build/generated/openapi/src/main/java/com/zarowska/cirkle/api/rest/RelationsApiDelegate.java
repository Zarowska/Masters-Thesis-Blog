...
/**
 * A delegate to be called by the {@link RelationsApiController}}.
...
public interface RelationsApiDelegate {
     ...
     * @see RelationsApi#acceptFriendshipRequestById
     */
    default ResponseEntity<Void> acceptFriendshipRequestById(UUID requestId) {
     ...
     * @return No Content (status code 204)
     * @see RelationsApi#deleteFriendFromUsersFriendsById
     */
    default ResponseEntity<Void> deleteFriendFromUsersFriendsById(UUID userId,
        UUID friendId) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
     ...
     *         or Forbidden (status code 403)
     *         or Internal Server Error (status code 500)
     * @see RelationsApi#findAllFriendshipRequests
     */
    default ResponseEntity<FriendshipRequestList> findAllFriendshipRequests() {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"items\" : [ { \"owner\" : { \"avatarUrl\" : \"https://openapi-generator.tech\", \"name\" : \"name\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\" }, \"createdAt\" : \"2000-01-23T04:56:07.000+00:00\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\" }, { \"owner\" : { \"avatarUrl\" : \"https://openapi-generator.tech\", \"name\" : \"name\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\" }, \"createdAt\" : \"2000-01-23T04:56:07.000+00:00\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\" } ] }";
     ...
     *         or Not Found (status code 404)
     *         or Internal Server Error (status code 500)
     * @see RelationsApi#getFriendshipRequestById
     */
    default ResponseEntity<FriendshipRequest> getFriendshipRequestById(UUID requestId) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"owner\" : { \"avatarUrl\" : \"https://openapi-generator.tech\", \"name\" : \"name\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\" }, \"createdAt\" : \"2000-01-23T04:56:07.000+00:00\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
     ...
     * @param size  (optional)
     * @return OK (status code 200)
     * @see RelationsApi#getUsersFriendsById
     */
    default ResponseEntity<UserPage> getUsersFriendsById(UUID userId,
        Integer page,
        Integer size) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
     ...
     *         or Not Found (status code 404)
     *         or Internal Server Error (status code 500)
     * @see RelationsApi#rejectFriendshipRequestById
     */
    default ResponseEntity<Void> rejectFriendshipRequestById(UUID requestId) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
     ...
     * @see RelationsApi#sendFrindshipRequest
     */
    default ResponseEntity<Void> sendFrindshipRequest(UUID userId) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
