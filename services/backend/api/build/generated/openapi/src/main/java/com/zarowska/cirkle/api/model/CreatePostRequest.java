...
public class CreatePostRequest implements Serializable {
    ...
    public CreatePostRequest images(List<@Valid URI> images) {
        this.images = images;
        return this;
    }

    public CreatePostRequest addImagesItem(URI imagesItem) {
        if (this.images == null) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.text, createPostRequest.text) && Objects.equals(this.images, createPostRequest.images);
    }
