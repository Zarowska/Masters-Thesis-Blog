...
public class UpdateUserMessageRequest implements Serializable {
    ...
    public UpdateUserMessageRequest text(String text) {
        this.text = text;
        return this;
    }
    ...
    public UpdateUserMessageRequest images(List<@Valid URI> images) {
        this.images = images;
        return this;
    }

    public UpdateUserMessageRequest addImagesItem(URI imagesItem) {
        if (this.images == null) {
    ...
    public boolean equals(Object o) {
        ...
        UpdateUserMessageRequest updateUserMessageRequest = (UpdateUserMessageRequest) o;
        return Objects.equals(this.text, updateUserMessageRequest.text) && Objects.equals(this.images, updateUserMessageRequest.images);
    }
    ...
    public String toString() {
        ...
        sb.append("class UpdateUserMessageRequest {\n");
