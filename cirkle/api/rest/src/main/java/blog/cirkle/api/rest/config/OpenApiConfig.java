	...
	public OpenAPI customOpenAPI() {
		return new OpenAPI()
				...
				.tags(List.of(new Tag().name("auth").description("Authentication and registration"),
						...
						new Tag().name("relations").description("User/Group relation operations"),
						new Tag().name("users").description("Users operations"),
						new Tag().name("posts").description("Post operations"),
						new Tag().name("reaction").description("Reaction operations"),
						new Tag().name("comments").description("Comments operations"),
